...
public class AvpsAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ViewSlotsLayout.setVerticalGroup(
            ...
            .addGroup(ViewSlotsLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(SlotUpdate, javax.swing.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE)
                .addGap(12, 12, 12))
        );
    ...
    private void CollectRevenueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CollectRevenueActionPerformed
        try
        {
            ...
            DBConnect.st.executeUpdate("update Parking set OutTime=CURRENT_TIMESTAMP,revenue="+revenue+",status='Exited' where SlipNo="+slipNo);  
            ResultSet rs=DBConnect.st.executeQuery("select VacantSlots from Parking_Area WHERE floorNo = '"+fn+"'");
            rs.next();
            int vs=rs.getInt(1);
            DBConnect.st.executeUpdate("update Parking_Area set VacantSlots="+(vs+1)+" WHERE floorNo = '"+fn+"'"); 
